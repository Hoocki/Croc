...
public class Figures {
    ...
    public String toString(){
            ...
            char str = ' ';
            if(this.x == 1){str = 'a';}
            else if (this.x == 2){str = 'b';}
            else if (this.x == 3){str = 'c';}
            else if (this.x == 4){str = 'd';}
            else if (this.x == 5){str = 'e';}
            else if (this.x == 6){str = 'f';}
            else if (this.x == 7){str = 'g';}
            else if (this.x == 8){str = 'h';}
            
        return String.format("(%c,%d)",str,this.y);
